...
namespace Godfrey.Commands
{
    [Group("mod")]
    [RequireOwner]
    public class ModCommand : BaseCommandModule
    {
        [Command("votekick")]
        public async Task VotekickAsync(CommandContext ctx, DiscordMember member, TimeSpan duration)
        {
            ...
            var timeFormat = duration.PrettyPrint();
                                        ...
                                        TimeSpan muteDuration)
        {
            ...
            {
                await
                        ctx.RespondAsync($"Votemute für {member.Mention} ist beendet. {yesCount} stimmen für und {noCount} gegen den Mute. Damit ergibt sich ein Prozentsatz von {got * 100}%. Du hältscht jetzt dein Schnautzen!");
            ...
            await
                    ctx.RespondAsync($"Votekick für {member.Mention} ist beendet. {yesCount} stimmen für und {noCount} gegen den Mute. Damit ergibt sich ein Prozentsatz von {got * 100}%. Kein Mute für ihn.");
        }
    }
}
